...
export default function BalanceCard({ totalAUM, unrealizedPnL, unrealizedPnLPct, onTotalClick, children }) {
  ...
  return (
    <div className="bg-surface-dark rounded-card p-5 text-white shadow-dark">
      ...
      <h2
        className={`text-3xl font-extrabold tracking-tight mb-1 ${onTotalClick ? 'cursor-pointer active:opacity-80' : ''}`}
        onClick={onTotalClick}
      >{formatIDR(totalAUM)}</h2>
